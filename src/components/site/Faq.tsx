...
const faqs = [
  { q: "What is FIFA WORLD GAMES?", a: "FIFA WORLD GAMES ($FWG) is a Solana memecoin powering a play-to-earn penalty shootout game launching during the FIFA World Cup 2026 hype season." },
  ...
  { q: "Is the game on Solana?", a: "Yes — 100% Solana. Instant payouts, sub-cent fees, and supports Phantom and Solflare wallets." },
  { q: "Where can I buy $FWG?", a: "$FWG launches fair on Pump.fun. After the bonded curve fills, $FWG moves to Raydium where you can swap from any Solana wallet." },
