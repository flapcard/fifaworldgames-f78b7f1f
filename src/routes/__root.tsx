...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Predict your shot, score goals, and earn $FWG rewards on BNB Chain during the biggest football hype season in the world." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Fifa World Games | Play. Score. Earn." },
      { property: "og:description", content: "Predict your shot, score goals, and earn $FWG rewards on BNB Chain during the biggest football hype season in the world." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Fifa World Games | Play. Score. Earn." },
      { name: "twitter:description", content: "Predict your shot, score goals, and earn $FWG rewards on BNB Chain during the biggest football hype season in the world." },
